...
for jj in range(10):
    ...
    plt.close()
    Ip_shales= Gslib().Gslib_read('C:/Users/roberto.miele/OneDrive - Universidade de Lisboa/6. SPADE/Input_synthetic_case/Ip_zone0_unc.out').data.Ip.values
    Ip_sands= Gslib().Gslib_read('C:/Users/roberto.miele/OneDrive - Universidade de Lisboa/6. SPADE/Input_synthetic_case/Ip_zone1_unc.out').data.Ip.values
