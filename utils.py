...
def prepare_parser():
    ...
    parser.add_argument('--data', type=str, default='channels'
                       ,help = 'type of data')
    parser.add_argument('--data_path', type=str, default='/work/rmiele//Training_Data_Norne/' 
                       ,help = 'data path')
    ...
    parser.add_argument('--resolution', type=list, default=[8,8]
                       ,help = 'resolution of the mask') 
    parser.add_argument('--real', type=bool, default=True, 
                        help='real case or synthetic')
    ...
    parser.add_argument('--spec_norm_G', default=True,action='store_true'
    ...
    parser.add_argument('--ema_decay',type = float, default=0.999
                        ,help = 'EMA decay rate')
    parser.add_argument('--decay_lr',type=str, default ='step'
                        ,help = 'if not None decay the learning rates (exp,step)')
    parser.add_argument('--r1penalty', type=bool, default = True, 
                        help='use r1penalty if Discriminator is too aggressive')
    ...
    # folder name
    parser.add_argument('--fname', type=str, default='retrain_norne_512'
...
def save_training_par(args):
  with open(args.fname+'/training_pars.txt', 'w') as f:
    print(args.__dict__)
...
class FaciesMaskDataset(Dataset):
    ...
    def __init__(self, root_dir, resolution, transform=None,real=False):
        ...
        self.lendata = os.listdir(root_dir+'/Facies')
